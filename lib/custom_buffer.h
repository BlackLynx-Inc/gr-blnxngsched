...
#ifndef INCLUDED_CUSTOM_BUFFER_H
#define INCLUDED_CUSTOM_BUFFER_H
...
class custom_buffer : public buffer_single_mapped
{
public:
    ...
    /*!
     * \brief Creates a new custom_buffer object
     *
     * \param nitems
     * \param sizeof_item
...
private:
    ...
    /*!
     * \brief constructor is private.  Use the static make_custom_buffer function
     * to create instances.
     *
...
#endif /* INCLUDED_CUSTOM_BUFFER_H */
